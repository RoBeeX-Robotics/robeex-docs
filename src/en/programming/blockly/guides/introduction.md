...
# Introduction to RoBeeX Blockly Environment

In this section you will get familiar with RoBeeX Blockly Environment
...
- [Installing RoBeeX App on your computer / mobile phone](../../../user-manuals/robeex-ai-drone/install-application)
...
Everything Blockly related is placed in the Programming section of the RoBeeX App

<p style="font-size: 1rem">
RoBeeX App → Programming → Blockly page
</p>

![Select top-left tile in the home page to enter programming environment](/assets/programming.webp)

## Blockly program manager

Here you can manage your blockly programs:
- [Select built-in demo programs and run / **clone** them](./demo-programs/run-or-duplicate)
