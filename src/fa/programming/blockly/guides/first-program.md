...
- یک اسکرین‌شات اضافه کنم و در مخزن قرار دهم (لطفاً یک تصویر فراهم کنید یا اجازه دهید ویرایشگر را ضبط کنم)، یا
- یک فایل نمونه دانلودی `.json` / `.blocks` مناسب برای وارد کردن در ویرایشگر ایجاد کنم.
