...
1. افزودن حلقه همیشه
	- از دسته `Loops`، بلوک `repeat while true` را بکشید و آن را زیر بلوک <code>When<img height="15px" width="15px" alt="logo" style="margin: 0 4px;display:inline;vertical-align: text-bottom;" src="/assets/icon/play-arrow.svg" />Clicked</code> قرار دهید.
...
6. تست برنامه
	- روی دکمه اجرا کلیک کنید<code><img height="15px" width="15px" alt="logo" style="margin: 0 4px;display:inline;vertical-align: text-bottom;" src="/assets/icon/play-arrow.svg" /></code> 
...
- دکمه Run غیرفعال <code><img height="15px" width="15px" alt="logo" style="margin: 0 4px;display:inline;vertical-align: text-bottom;" src="/assets/icon/play-arrow.svg" /></code> 
